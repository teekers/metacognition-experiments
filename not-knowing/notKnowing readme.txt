Instructions: language for Cooperative (OP) or Competitive (MP)

Word Pairs:
1. Study presentation
- - parameters: # seconds, default or short/long, % trials with no study
2. Test phase
- Show cue, target blank. Buttons: “I know it” vs “I don’t know it”
- - if yes, type in response, record RT
- - if no, slider for confidence rating
3. Retest
- Show cue-target pairs that were wrong. “Had you studied this in Phase 1?” Buttons: 
“No it’s not familiar” vs “Yes it turns out I did”

Trivia:
1. Test Phase
- Show question. Buttons: “I know it” vs “I don’t know it”
2. Retest
- Show questions they got wrong. “Had you actually known it at one point?” Buttons: “Yes” vs “No”
 


—————————
Changes made June 2015:
- changed default params
- better handling for file errors
- compiled for PC 
